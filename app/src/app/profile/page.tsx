...
import PriceChart3 from "./pricechart3";
import AssetItem from "./asset_value";
...
const Profile = () => {
  return (
    <div
      className="gap-3 h-screen grid grid-cols-10 grid-rows-8 p-3 m-0 box-border"
      style={{ backgroundColor: backgroundColor }}
    >
      {/* Header */}
      <div
        className="col-start-1 col-end-12 flex"
        style={{ backgroundColor: backgroundColor }}
      >
      ...
      {/* Body */}
      <div
        className="col-start-1 col-end-6 row-start-2 row-end-5 rounded relative"
      ...
      <div
        className="col-start-6 col-end-11 row-start-2 row-end-5 rounded "
        style={{ backgroundColor: boxColor }}
      >
      ...
      <div
        className="col-start-1 col-end-3 row-start-5 row-end-9 rounded "
        style={{ backgroundColor: boxColor }}
      >
        <AssetItem />
      </div>
